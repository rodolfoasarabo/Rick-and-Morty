...
interface CharacterModelToUiModelMapper {
    fun mapFrom(from: CharacterModel): CharacterUiModel
}

class CharacterModelToUiModelMapperImpl @Inject constructor() : CharacterModelToUiModelMapper {

    override fun mapFrom(from: CharacterModel): CharacterUiModel {
